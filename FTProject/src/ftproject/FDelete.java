...
public class FDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELETE FIR RECORD");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(fid, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       boolean flag = false;
       for(int i=0; i< FTProject.getInstance().getFirList().size(); i++)
       {
           if(id.equals(FTProject.getInstance().getFirList().get(i).getFirNumber()))
           {
               FTProject.getInstance().getFirList().remove(i);
